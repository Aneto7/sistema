...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Cadastro de Cartão de Abastecimento</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Cadastro de Cartão de Abastecimento</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Cadastro ></a></li>
                        <li><a href="javascript:void(0);">Controle de Abastecimento </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
        ...
        <section class="content">
            <% CartaoAbastecimentoDAO cdao = new CartaoAbastecimentoDAO();%>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_9">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                            Cadastro de Cartão de Abastecimento<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="body">
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campoplaca" name="campoplaca" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <% for(PlacaCadastrada placa: fdao.listarPlacaCadastrada()){ %>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campodescricao" name="campodescricao" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <option>Cartão Estoque</option>
                                                        <option>Cartão Financeiro</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="camporesponsavel" name="camporesponsavel" required>
                                                            <label class="form-label">Digitar Responsavel</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="number" class="form-control" id="campocentrocusto" name="campocentrocusto" required>
                                                            <label class="form-label">Digitar Centro de Custo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="atualizarcartao" id="atualizarcartao" value="atualizarcartao" class="btn bg-cyan btn-block waves-effect" onclick="atualizarCartao()">
                                                    <i class="material-icons">refresh</i>
                                                    <span>Atualizar</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="excluircartao" id="excluircartao" value="excluircartao" class="btn bg-cyan btn-block waves-effect" onclick="excluirCartao()">
                                                    <i class="material-icons">delete_forever</i>
                                                    <span>Excluir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="inserircartao" id="inserircartao" value="inserircartao" class="btn bg-cyan btn-block waves-effect" onclick="inserirCartao()">
                                                    <i class="material-icons">save</i>
                                                    <span>Inserir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button type="button" name="limparcartao" id="limparcartao" value="limparcartao" class="btn bg-cyan btn-block waves-effect" onclick="limparCartao()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA CARTÕES DE ABASTECIMENTO<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelaCartaoCar" name="tabelaCartaoCar" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Cartão</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% for(CartaoCar cartaocar: cdao.listarCartao()){ %>
                                                    <tr value="<%=cartaocar.getId()%>">
                                                        <td id="id" data-name="<%=cartaocar.getId()%>"><%=cartaocar.getId()%></td>
                                                        <td><%=cartaocar.getCartao()%></td>
                                                        <td><%=cartaocar.getVeiculo()%></td>
                                                        <td><%=cartaocar.getDescricao()%></td>
                                                        <td><%=cartaocar.getResponsavel()%></td>
                                                        <td><%=cartaocar.getStatus()%></td>
                                                        <td><%=cartaocar.getCentrocusto()%></td>
                                                    </tr>
                                                    <% } %>
                                                </tbody>
                                            </table>
        ...
        <script src="../../js/pages/cadastro/scriptcadastrocartaocar.js"></script>
