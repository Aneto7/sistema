...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Controle Justificativa</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="javascript:void(0);">Controle </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
                    ...
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="campobdgmes" name="campobdgmes" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValoresAnalises()){%>
                                 <%=cont.getBdgmes()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_1">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                            TABELA DE JUSTIFICATIVAS<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                <!-- Exportable Table -->
                                        ...
                                        <div id="tabela" name="tabela" class="body">
                                            <div class="table-responsive">
                                                <table id="tabelaOrcamento" name="tabelaOrcamento" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                    ...
                                                    for(Analise analise1: andao.listarAnalise()){ %>
        ...
        <script src="../../js/scriptcontroleanalise.js"></script>
