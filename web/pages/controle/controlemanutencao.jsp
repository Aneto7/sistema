...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Controle de Manutenção</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Controle de Manutenção</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Controle ></a></li>
                        <li><a href="javascript:void(0);">Manutenção </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Média de Manutenção</div>
                            <div id="campoultimamanutencao" name="campoultimamanutencao" class="number count-to" data-from="0" data-to="500" data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Soma de Manutenção</div>
                            <div id="camposomamanutencao" name="camposomamanutencao" class="number count-to" data-from="0" data-to="500" data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_9">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                            Cadastro de Manutenção<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="body">
                                                ...
                                                <div class="col-md-3">
                                                    <p>
                                                        <b>Grupo de Manutenção</b>
                                                    </p>
                                                    <select id="campogrupomanutencao" name="campogrupomanutencao" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select id="campoorcamento" name="campoorcamento" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <label for="md_checkbox_10">Liberado</label>
                                                </div>
                                                <div class="col-md-4">
                                                    <p>
                                                    ...
                                                    <select id="campoid" name="campoid" class="form-control show-tick" data-live-search="true">
                                                        ...
                                                        <% for(IdCombustivel id: fdao.listarIdManutencoes()){ %>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <textarea id="campodetalhemanutencao" name="campodetalhemanutencao" rows="4" class="form-control no-resize auto-growth" placeholder="Inserir aqui od detalhes sobre a manutenção"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="atualizarmanutencao" id="atualizarmanutencao" value="atualizarmanutencao" class="btn bg-cyan btn-block waves-effect" onclick="atualizarManutencao()">
                                                    <i class="material-icons">refresh</i>
                                                    <span>Atualizar</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="excluirmanutencao" id="excluirmanutencao" value="excluirmanutencao" class="btn bg-cyan btn-block waves-effect" onclick="excluirManutencao()">
                                                    <i class="material-icons">delete_forever</i>
                                                    <span>Excluir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="inserirmanutencao" id="inserirmanutencao" value="inserirmanutencao" class="btn bg-cyan btn-block waves-effect" onclick="inserirManutencao()">
                                                    <i class="material-icons">save</i>
                                                    <span>Inserir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button type="button" name="limparmanutencao" id="limparmanutencao" value="limparmanutencao" class="btn bg-cyan btn-block waves-effect" onclick="limparManutencao()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_1" href="#collapseOne_1" aria-expanded="true" aria-controls="collapseOne_1">
                                        Manutenções Cadastradas<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-6">
                                        <div class="input-group spinner" data-trigger="spinner">
                                            <div class="form-line">
                                                <input id="spinnermanutencao" name="spinnermanutencao" type="text" class="form-control text-center" value="1" data-rule="quantity">
                                            </div>
                                            <span class="input-group-addon">
                                                <a href="javascript:;" class="spin-down" data-spin="down" onclick="filtrarManutencao()"><i class="glyphicon glyphicon-chevron-up"></i></a>
                                                <a href="javascript:;" class="spin-up" data-spin="up" onclick="filtrarManutencao()"><i class="glyphicon glyphicon-chevron-down"></i></a>
                                            </span>
                                        </div>
                                    </div>
                                    <div id="numeromanutencoes" name="numeromanutencoes" class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <button id="manutencaonumero" name="manutencaonumero" class="btn bg-cyan btn-lg btn-block waves-effect" type="button"> 
                                            <% for(Contagens cont: fdao.contarManutencoes()){%>
                                    ...
                                    <div class="col-md-12">
                                        <div id="dadosjus1" name="dadosjus1" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <% for(Manutencao manutencao: mdao.listarManutencao()){
                                        if (manutencao.getNumeromanutencoes()== 1){%>
                                            <ul>
                                                <li id="manutencaoplaca" name="manutencaoplaca"><%=manutencao.getPlaca()%></li>
                                                <li id="manutencaoinicio" name="manutencaoinicio"><%=manutencao.getDatainicio()%></li>
                                                <li id="manutencaofim" name="manutencaofim"><%=manutencao.getDatafim()%></li>
                                            </ul>
                                        </div>
                                        <div id="dadosjus2" name="dadosjus2" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <ul>
                                                <li id="manutencaogrupoorcamento" name="manutencaogrupoorcamento"><%=manutencao.getGrupomanutencao()%></li>
                                                <li id="manutencaovalor" name="manutencaovalor"><%=manutencao.getValor()%></li>
                                                <li id="manutencaoorcamento" name="manutencaoorcamento"><%=manutencao.getOrcamento()%></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="col-md-12">
                                            <div id="manutencaodetalhe" name="manutencaodetalhe"><%=manutencao.getDetalhe()%></div>
                                            <%}}%>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA DE MANUTENÇÃO<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelaManutencao" name="tabelaManutencao" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Placa</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    ...
                                                    for(Manutencao manutencao: mandao.listarManutencao()){ %>
                                                    <tr value="<%=manutencao.getId()%>">
                                                        <td id="id" data-name="<%=manutencao.getId()%>"><%=manutencao.getId()%></td>
                                                        <td><%=manutencao.getPlaca()%></td>
                                                        <td><%=manutencao.getDatainicio()%></td>
                                                        <td><%=manutencao.getDatafim()%></td>
                                                        <td><%=manutencao.getGrupomanutencao()%></td>
                                                        <td><%=manutencao.getValor()%></td>
                                                        <td><%=manutencao.getResponsavel()%></td>
                                                        <td><%=manutencao.getOrcamento()%></td>
                                                        <td><%=manutencao.getCarroreserva()%></td>
                                                    </tr>
                                                    <% } %>
                                                </tbody>
                                            </table>
        ...
        <script src="../../js/pages/controle/scriptcontrolemanutencao.js"></script>
