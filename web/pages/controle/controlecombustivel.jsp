...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Cadastro de Combustível</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Controle de Combustível</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Controle ></a></li>
                        <li><a href="javascript:void(0);">Combustível </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Valor Total</div>
                            <div id="campomediamensal" name="campomediamensal" class="number count-to" data-from="0" data-to="500" data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Média de Abastecimento</div>
                            <div id="campoacumuladoanual" name="campoacumuladoanual" class="number count-to" data-from="0" data-to="500" data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_9">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                        Dados para Cadastro de Abastecimento<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="body">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campocartao" name="campocartao" class="form-control show-tick" data-live-search="true">
                                                    <% for(Cartao cartao: fdao.listarCartao()){ %>
                                                    <option value=<%=cartao.getId()%>><%=cartao.getCartao()%></option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campocentro" name="campocentro" class="form-control show-tick" data-live-search="true">
                                                    <% for(Centro centro: fdao.listarCentro()){ %>
                                                    <option value=<%=centro.getId()%>><%=centro.getCentro()%></option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="number" class="form-control" id="campolitros" name="campolitros" required>
                                                        <label class="form-label">Digitar Valor</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campoid" name="campoid" class="form-control show-tick" data-live-search="true">
                                                    ...
                                                    <% for(IdCombustivel id: fdao.listarIdCombustivel()){ %>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <button data-type="success" type="button" name="atualizarcombustivel" id="atualizarcombustivel" value="atualizarcombustivel" class="btn bg-cyan btn-block waves-effect" onclick="atualizarCombustivel()">
                                                <i class="material-icons">refresh</i>
                                                <span>Atualizar</span>
                                            </button>
                                        </div>
                                        <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <button data-type="success" type="button" name="excluircombustivel" id="excluircombustivel" value="excluircombustivel" class="btn bg-cyan btn-block waves-effect" onclick="excluirCombustivel()">
                                                <i class="material-icons">delete_forever</i>
                                                <span>Excluir</span>
                                            </button>
                                        </div>
                                        <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <button data-type="success" type="button" name="inserircombustivel" id="inserircombustivel" value="inserircombustivel" class="btn bg-cyan btn-block waves-effect" onclick="inserirCombustivel()">
                                                <i class="material-icons">save</i>
                                                <span>Inserir</span>
                                            </button>
                                        </div>
                                        <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <button type="button" name="limparcombustivel" id="limparcombustivel" value="limparcombustivel" class="btn bg-cyan btn-block waves-effect" onclick="limparCombustivel()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA DE ABASTECIMENTO<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelaAbastecimento" name="tabelaAbastecimento" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Placa</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% CombustivelDAO comdao = new CombustivelDAO();
                                                    for(Combustivel combustivel1: comdao.listarCombustivel()){ %>
                                                    <tr value="<%=combustivel1.getId()%>">
                                                        <td id="id" data-name="<%=combustivel1.getId()%>"><%=combustivel1.getId()%></td>
                                                        <td><%=combustivel1.getPlaca()%></td>
                                                        <td><%=combustivel1.getCartao()%></td>
                                                        <td><%=combustivel1.getData()%></td>
                                                        <td><%=combustivel1.getValor()%></td>
                                                        <td><%=combustivel1.getLitros()%></td>
                                                        <td><%=combustivel1.getKM()%></td>
                                                        <td><%=combustivel1.getCondutor()%></td>
                                                    </tr>
                                                    <% } %>
                                                </tbody>
                                            </table>
        ...
        <!-- Custom Js -->
        <script src="../../js/pages/controle/scriptcontroleabastecimento.js"></script>
