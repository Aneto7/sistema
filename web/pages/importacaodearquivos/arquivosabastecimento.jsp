...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Importar Arquivo de Abastecimento</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Importar Arquivo de Abastecimento</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Importar ></a></li>
                        <li><a href="javascript:void(0);">Abastecimento </a></li>
                        <!-- Call Search -->
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                                ...
                                <span class="label-count">7</span> <!-- Inserir uma contagem de número de notificações para análise -->
                            </a>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            <a href="../../pages/analiseorcamento/pendenciajustificativa.jsp">
                                                ...
                                                <div class="menu-info">
                                                    <h4>12 Solicitações de análise</h4><!-- Inserir o número de análises para este usuário-->
                                                </div>
                                            </a>
                                        </li>
                                        <li hidden>
                            ...
                            <div id="collapseOne_2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_2">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="campoures" name="campoures" class="form-control show-tick" data-live-search="true">
                                            <option></option>
