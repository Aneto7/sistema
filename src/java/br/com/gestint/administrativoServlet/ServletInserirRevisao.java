 ...
 * @author Antonio
 */
public class ServletInserirRevisao extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO `revisoes` (`ID`, `PLACA`, `LOCADORA`, `BASE`, `KM`, `DATA`, `OBSERVACAO`) VALUES (NULL, '" + nomeplaca
                    + "', '" + nomelocadora + "', '" + nomebase + "', '" + km + "', '" + data + "', '" + nomedetalhe + "');");
