 ...
 * @author rosaan
 */
public class ServletFiltroNumerosCombustivel extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeQuery("SELECT ID, SUM(VALOR) AS VALORES, AVG(VALOR) AS AVGVALOR FROM `combustivel` WHERE "
            ...
            while (rs.next()) {
                ...
                comb.setValor(rs.getDouble("VALORES"));
                comb.setLitros(rs.getDouble("AVGVALOR"));
                combs.add(comb);
            }
        ...
        for (int i = 0; i < combs.size(); i++) {
            sb.append(combs.get(i).getId() + "%" + combs.get(i).getValor() + "%" + combs.get(i).getLitros() + ";");
        }
