 ...
 * @author Antonio
 */
public class ServletAtualizarManutencao extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeUpdate("UPDATE manutencao SET PLACA='"
                    + nomeplaca + "',DATA_INICIO='"
                    + nomedatainicio + "',DATA_FIM='"
                    + nomedatafim + "',GRUPO_MANUTENCAO='"
                    + nomegrupomanutencao + "',VALOR='"
                    + nomevalor + "',RESPONSAVEL='"
                    + nomeresponsavel + "',ORCAMENTO='"
                    + nomeorcamento + "',DETALHE='"
                    + nomedetalhe + "',CARRO_RESERVA='"
                    + nomecarroreserva
                    + "' WHERE ID='" + nomeid + "'");
