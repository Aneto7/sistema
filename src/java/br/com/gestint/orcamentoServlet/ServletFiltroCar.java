 ...
 * @author rosaan
 */
public class ServletFiltroCar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeQuery("SELECT MIN(ID) AS ID, SUM(IF((MES='JAN' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_JAN, SUM(IF((MES='FEV' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_FEV, SUM(IF((MES='MAR' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_MAR, SUM(IF((MES='ABR' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_ABR, SUM(IF((MES='MAI' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_MAI, SUM(IF((MES='JUN' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_JUN, SUM(IF((MES='JUL' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_JUL, SUM(IF((MES='AGO' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_AGO, SUM(IF((MES='SET' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_SET, SUM(IF((MES='OUT' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_OUT, SUM(IF((MES='NOV' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_NOV, SUM(IF((MES='DEZ' AND TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL_DEZ, SUM(IF((TIPO='CAR' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS CARREAL FROM `apoioorcamento` WHERE "
            ...
            while (rs1.next()) {
                ...
                mes1volreal = rs1.getDouble("CARREAL_JAN");
                mes2volreal = rs1.getDouble("CARREAL_FEV");
                mes3volreal = rs1.getDouble("CARREAL_MAR");
                mes4volreal = rs1.getDouble("CARREAL_ABR");
                mes5volreal = rs1.getDouble("CARREAL_MAI");
                mes6volreal = rs1.getDouble("CARREAL_JUN");
                mes7volreal = rs1.getDouble("CARREAL_JUL");
                mes8volreal = rs1.getDouble("CARREAL_AGO");
                mes9volreal = rs1.getDouble("CARREAL_SET");
                mes10volreal = rs1.getDouble("CARREAL_OUT");
                mes11volreal = rs1.getDouble("CARREAL_NOV");
                mes12volreal = rs1.getDouble("CARREAL_DEZ");
                acumvolreal = rs1.getDouble("CARREAL");
