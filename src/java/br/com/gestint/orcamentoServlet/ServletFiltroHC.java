 ...
 * @author rosaan
 */
public class ServletFiltroHC extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeQuery("SELECT MIN(ID) AS ID, SUM(BDG_JAN) AS BDG_JAN, SUM(BDG_FEV) AS BDG_FEV, SUM(BDG_MAR) AS BDG_MAR, SUM(BDG_ABR) AS BDG_ABR, SUM(BDG_MAI) AS BDG_MAI, SUM(BDG_JUN) AS BDG_JUN, SUM(BDG_JUL) AS BDG_JUL, SUM(BDG_AGO) AS BDG_AGO, SUM(BDG_SET) AS BDG_SET, SUM(BDG_OUT) AS BDG_OUT, SUM(BDG_NOV) AS BDG_NOV, SUM(BDG_DEZ) AS BDG_DEZ, SUM(REAL_JAN) AS REAL_JAN, SUM(REAL_FEV) AS REAL_FEV, SUM(REAL_MAR) AS REAL_MAR, SUM(REAL_ABR) AS REAL_ABR, SUM(REAL_MAI) AS REAL_MAI, SUM(REAL_JUN) AS REAL_JUN, SUM(REAL_JUL) AS REAL_JUL, SUM(REAL_AGO) AS REAL_AGO, SUM(REAL_SET) AS REAL_SET, SUM(REAL_OUT) AS REAL_OUT, SUM(REAL_NOV) AS REAL_NOV, SUM(REAL_DEZ) AS REAL_DEZ, " + bdgacumuladomes + " AS BDG_ACUM, " + realacumuladomes + " AS REAL_ACUM FROM `orcamentocontrole` WHERE "
                    ...
                    + "' AND `MAGNITUDE_CONTA` LIKE 'Employment Cost"
                    + "'");
            ...
            st.executeQuery("SELECT MIN(ID) AS ID, SUM(IF((MES='JAN' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_JAN, SUM(IF((MES='FEV' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_FEV, SUM(IF((MES='MAR' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_MAR, SUM(IF((MES='ABR' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_ABR, SUM(IF((MES='MAI' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_MAI, SUM(IF((MES='JUN' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_JUN, SUM(IF((MES='JUL' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_JUL, SUM(IF((MES='AGO' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_AGO, SUM(IF((MES='SET' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_SET, SUM(IF((MES='OUT' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_OUT, SUM(IF((MES='NOV' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_NOV, SUM(IF((MES='DEZ' AND TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN_DEZ, SUM(IF((TIPO='HEADCOUNT' AND PLANOUREAL='PLANEJADO'), VALOR, 0)) AS HEADCOUNTPLAN, SUM(IF((MES='JAN' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_JAN, SUM(IF((MES='FEV' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_FEV, SUM(IF((MES='MAR' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_MAR, SUM(IF((MES='ABR' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_ABR, SUM(IF((MES='MAI' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_MAI, SUM(IF((MES='JUN' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_JUN, SUM(IF((MES='JUL' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_JUL, SUM(IF((MES='AGO' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_AGO, SUM(IF((MES='SET' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_SET, SUM(IF((MES='OUT' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_OUT, SUM(IF((MES='NOV' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_NOV, SUM(IF((MES='DEZ' AND TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL_DEZ, SUM(IF((TIPO='HEADCOUNT' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS HEADCOUNTREAL FROM `apoioorcamento` WHERE "
            ...
            while (rs1.next()) {
                ...
                mes1volplan = rs1.getDouble("HEADCOUNTPLAN_JAN");
                mes2volplan = rs1.getDouble("HEADCOUNTPLAN_FEV");
                mes3volplan = rs1.getDouble("HEADCOUNTPLAN_MAR");
                mes4volplan = rs1.getDouble("HEADCOUNTPLAN_ABR");
                mes5volplan = rs1.getDouble("HEADCOUNTPLAN_MAI");
                mes6volplan = rs1.getDouble("HEADCOUNTPLAN_JUN");
                mes7volplan = rs1.getDouble("HEADCOUNTPLAN_JUL");
                mes8volplan = rs1.getDouble("HEADCOUNTPLAN_AGO");
                mes9volplan = rs1.getDouble("HEADCOUNTPLAN_SET");
                mes10volplan = rs1.getDouble("HEADCOUNTPLAN_OUT");
                mes11volplan = rs1.getDouble("HEADCOUNTPLAN_NOV");
                mes12volplan = rs1.getDouble("HEADCOUNTPLAN_DEZ");
                acumvolplan = rs1.getDouble("HEADCOUNTPLAN");
                mes1volreal = rs1.getDouble("HEADCOUNTREAL_JAN");
                mes2volreal = rs1.getDouble("HEADCOUNTREAL_FEV");
                mes3volreal = rs1.getDouble("HEADCOUNTREAL_MAR");
                mes4volreal = rs1.getDouble("HEADCOUNTREAL_ABR");
                mes5volreal = rs1.getDouble("HEADCOUNTREAL_MAI");
                mes6volreal = rs1.getDouble("HEADCOUNTREAL_JUN");
                mes7volreal = rs1.getDouble("HEADCOUNTREAL_JUL");
                mes8volreal = rs1.getDouble("HEADCOUNTREAL_AGO");
                mes9volreal = rs1.getDouble("HEADCOUNTREAL_SET");
                mes10volreal = rs1.getDouble("HEADCOUNTREAL_OUT");
                mes11volreal = rs1.getDouble("HEADCOUNTREAL_NOV");
                mes12volreal = rs1.getDouble("HEADCOUNTREAL_DEZ");
                acumvolreal = rs1.getDouble("HEADCOUNTREAL");
