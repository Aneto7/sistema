 ...
 * @author rosaan
 */
public class ServletFiltroWood extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeQuery("SELECT MIN(ID) AS ID, SUM(IF((MES='JAN' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_JAN, SUM(IF((MES='FEV' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_FEV, SUM(IF((MES='MAR' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_MAR, SUM(IF((MES='ABR' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_ABR, SUM(IF((MES='MAI' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_MAI, SUM(IF((MES='JUN' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_JUN, SUM(IF((MES='JUL' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_JUL, SUM(IF((MES='AGO' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_AGO, SUM(IF((MES='SET' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_SET, SUM(IF((MES='OUT' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_OUT, SUM(IF((MES='NOV' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_NOV, SUM(IF((MES='DEZ' AND TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD_DEZ, SUM(IF((TIPO='WOOD' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS WOOD, SUM(IF((MES='JAN' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_JAN, SUM(IF((MES='FEV' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_FEV, SUM(IF((MES='MAR' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_MAR, SUM(IF((MES='ABR' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_ABR, SUM(IF((MES='MAI' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_MAI, SUM(IF((MES='JUN' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_JUN, SUM(IF((MES='JUL' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_JUL, SUM(IF((MES='AGO' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_AGO, SUM(IF((MES='SET' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_SET, SUM(IF((MES='OUT' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_OUT, SUM(IF((MES='NOV' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_NOV, SUM(IF((MES='DEZ' AND TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM_DEZ, SUM(IF((TIPO='SECAGEM' AND PLANOUREAL='REALIZADO'), VALOR, 0)) AS SECAGEM FROM `apoioorcamento` WHERE "
            ...
            while (rs1.next()) {
                ...
                mes1volplan = rs1.getDouble("WOOD_JAN");
                mes2volplan = rs1.getDouble("WOOD_FEV");
                mes3volplan = rs1.getDouble("WOOD_MAR");
                mes4volplan = rs1.getDouble("WOOD_ABR");
                mes5volplan = rs1.getDouble("WOOD_MAI");
                mes6volplan = rs1.getDouble("WOOD_JUN");
                mes7volplan = rs1.getDouble("WOOD_JUL");
                mes8volplan = rs1.getDouble("WOOD_AGO");
                mes9volplan = rs1.getDouble("WOOD_SET");
                mes10volplan = rs1.getDouble("WOOD_OUT");
                mes11volplan = rs1.getDouble("WOOD_NOV");
                mes12volplan = rs1.getDouble("WOOD_DEZ");
                acumvolplan = rs1.getDouble("WOOD");
                mes1volreal = rs1.getDouble("SECAGEM_JAN");
                mes2volreal = rs1.getDouble("SECAGEM_FEV");
                mes3volreal = rs1.getDouble("SECAGEM_MAR");
                mes4volreal = rs1.getDouble("SECAGEM_ABR");
                mes5volreal = rs1.getDouble("SECAGEM_MAI");
                mes6volreal = rs1.getDouble("SECAGEM_JUN");
                mes7volreal = rs1.getDouble("SECAGEM_JUL");
                mes8volreal = rs1.getDouble("SECAGEM_AGO");
                mes9volreal = rs1.getDouble("SECAGEM_SET");
                mes10volreal = rs1.getDouble("SECAGEM_OUT");
                mes11volreal = rs1.getDouble("SECAGEM_NOV");
                mes12volreal = rs1.getDouble("SECAGEM_DEZ");
                acumvolreal = rs1.getDouble("SECAGEM");
