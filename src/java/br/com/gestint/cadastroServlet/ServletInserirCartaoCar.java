 ...
 * @author Antonio
 */
public class ServletInserirCartaoCar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String nomedescricao = request.getParameter("iddescricao");
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO `cartoes_ticketcar` (`ID`, `CARTAO`, `VEICULO`, `DESCRICAO`, "
                    + "`RESPONSAVEL`, `STATUS`, `CENTRO_DE_CUSTO`) VALUES (NULL, '" + nomecartao + "', '" + nomeplaca + "', "
                    + "'" + nomedescricao + "', '" + nomeresponsavel + "', '" + nomestatus + "', '" + nomecentro + "');");
