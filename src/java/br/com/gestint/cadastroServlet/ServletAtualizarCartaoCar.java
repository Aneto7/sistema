 ...
 * @author Antonio
 */
public class ServletAtualizarCartaoCar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeUpdate("UPDATE cartoes_ticketcar SET CARTAO='"
                    + nomecartao + "',DESCRICAO='"
                    + nomedescricao + "',RESPONSAVEL='"
                    + nomeresponsavel + "',STATUS='"
                    + nomestatus + "',CENTRO_DE_CUSTO='"
                    + nomecentro
                    + "' WHERE VEICULO='" + nomeplaca + "'");
