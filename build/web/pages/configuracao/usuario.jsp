...
<%@page import="br.com.gestint.configuracao.*;" %>
<%@page import="br.com.gestint.configuracaoDAO.*;" %>
...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Configuração de Usuário</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Configuração de Usuário</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Configuração ></a></li>
                        <li><a href="javascript:void(0);">Usuário </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
        ...
        <section class="content">
            <% FiltroConfiguracaoDAO fdao = new FiltroConfiguracaoDAO();%>
            <!-- Widgets -->
            <div>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_9">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                            Cadastro de Usuário<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="campousuario" name="campousuario" required>
                                                                <label class="form-label">Digitar usuário</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="email" class="form-control" id="campoemail" name="campoemail" required>
                                                                <label class="form-label">Digitar e-mail</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="camposetor" name="camposetor" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <option>Controle de Estoque e Orcamento</option>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campoperfil" name="campoperfil" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campoid" name="campoid" class="form-control show-tick" data-live-search="true">
                                                        ...
                                                        <% for(Usuario usuario: fdao.listarUsuario()){ %>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="atualizarusuario" id="atualizarusuario" value="atualizarusuario" class="btn bg-cyan btn-block waves-effect" onclick="atualizarUsuario()">
                                                    <i class="material-icons">refresh</i>
                                                    <span>Atualizar</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="excluirusuario" id="excluirusuario" value="excluirusuario" class="btn bg-cyan btn-block waves-effect" onclick="excluirUsuario()">
                                                    <i class="material-icons">delete_forever</i>
                                                    <span>Excluir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="inserirusuario" id="inserirusuario" value="inserirusuario" class="btn bg-cyan btn-block waves-effect" onclick="inserirUsuario()">
                                                    <i class="material-icons">save</i>
                                                    <span>Inserir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button type="button" name="limparusuario" id="limparusuario" value="limparusuario" class="btn bg-cyan btn-block waves-effect" onclick="limparUsuario()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA USUÁRIOS<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelausuario" name="tabelausuario" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Nome</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% for(Usuario usuario: fdao.listarUsuario()){ %>
                                                    <tr value="<%=usuario.getIdusuario()%>">
                                                        <td id="id" data-name="<%=usuario.getIdusuario()%>"><%=usuario.getIdusuario()%></td>
                                                        <td><%=usuario.getNome()%></td>
                                                        <td><%=usuario.getEmail()%></td>
                                                        <td><%=usuario.getRegiao()%></td>
                                                        <td><%=usuario.getFilial()%></td>
        ...
        <script src="../../js/pages/configuracao/scriptconfiguracaousuario.js"></script>
