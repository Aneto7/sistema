...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Justificativas Pendentes</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Controle de Justificativas</a>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarjustificativas.jsp">Justificativa ></a></li>
                        <li><a href="javascript:void(0);">Pendências </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="body">
                                            <div class="col-md-3">
                                                ...
                                                <select id="campoidpendencia" name="campoidpendencia" class="form-control show-tick" data-live-search="true" disabled>
                                                    <option></option>
                                                    <% for(Analise analise2: adao.listarAnalisePendente()){ %>
                                                    <option value=<%=analise2.getId()%>><%=analise2.getId()%></option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <select id="campoarea" name="campoarea" class="form-control show-tick" data-live-search="true" disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campoplataforma" name="campoplataforma" class="form-control show-tick" data-live-search="true" disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="camporegiao" name="camporegiao" class="form-control show-tick" data-live-search="true" disabled>
                                                    <%if(!perfillog.equals("Administrador")){%>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campofilial" name="campofilial" class="form-control show-tick" data-live-search="true" disabled>
                                                    <%if(perfillog.equals("Operacional")){%>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campomagnitude" name="campomagnitude" class="form-control show-tick" data-live-search="true" disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campocentrodecusto" name="campocentrodecusto" class="form-control show-tick" data-live-search="true" disabled>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="campoconta" name="campoconta" class="form-control show-tick" data-live-search="true" disabled>
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        LISTA DE SOLICITAÇÕES DE JUSTIFICATIVAS<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelaOrcamento" name="tabelaOrcamento" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>Plataforma</th>
                                                        <th>Área</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% AnaliseDAO andao = new AnaliseDAO();
                                                    for(Analise analise1: andao.listarAnalisePendente()){ %>
                                                    <tr value="<%=analise1.getId()%>">
                                                        <td id="id" data-name="<%=analise1.getId()%>"><%=analise1.getPlataforma()%></td>
                                                        <td><%=analise1.getArea()%></td>
                                                        <td><%=analise1.getRegiao()%></td>
                                                        <td><%=analise1.getDesccentrocusto()%></td>
                                                        <td><%=analise1.getFilial()%></td>
                                                        <td><%=analise1.getMagnitude()%></td>
                                                        <td><%=analise1.getDescconta()%></td>
                                                        <td><%=analise1.getBdgmes()%></td>
                                                        <td><%=analise1.getRealmes()%></td>
                                                        <td><%=analise1.getDifmes()%></td>
                                                        <td><%=analise1.getBdgacum()%></td>
                                                        <td><%=analise1.getRealacum()%></td>
                                                        <td><%=analise1.getDifacum()%></td>
                                                    </tr>
                                                    <% } %>
                                                </tbody>
                                            </table>
                        ...
                        <div class="panel-heading" role="tab" id="headingOne_1">
                            <h4 class="panel-title">
                                <a role="button" data-toggle="collapse" data-parent="#accordion_2" href="#collapseOne_2" aria-expanded="true" aria-controls="collapseOne_2">
                                    Lançamento de Justificativas<i class="material-icons">view_headline</i>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseOne_2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_2">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea id="campojustificativa" name="campojustificativa" rows="3" class="form-control no-resize auto-growth" placeholder="Inserir aqui a justificativa"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="collapseOne_2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_2">
                                <div class="panel-body">
                                    <div class="col-md-3">
                                        <p>
                                            <b>Tipo de Justificativa</b>
                                        </p>
                                        <select id="tipojus" name="tipojus" class="form-control show-tick" data-live-search="true">
                                            <option></option>
                                            <option>DENTRO DO ORCAMENTO ANUAL</option>
                                            <option>ORCAMENTO SUBESTIMADO</option>
                                            <option>ORCAMENTO SUPERESTIMADO</option>
                                            <option>SEM ORCAMENTO</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <p>
                                            <b>Vincular Responsável</b>
                                        </p>
                                        <% 
                                           String ocultarfilial = "";
                                           if(perfillog.equals("Operacional")){
                                           ocultarfilial = " disabled";
                                        }%>
                                        <select id="campoures" name="campoures" class="form-control show-tick" data-live-search="true"<%=ocultarfilial%>>
                                            <option></option>
                                            <% for(Responsavel resp: fdao.listarResponsavel()){ %>
                                            <option><%=resp.getResponsavel()%></option>
                                            <% } %>
                                        </select>
                                    </div>
                                    <div class="js-sweetalert">
                                        <button data-type="success" type="button" name="justificar" id="justificar" value="Enviar" class="btn bg-cyan btn-block btn-xs waves-effect" onclick="salvarAnalise()">Incluir Justificativa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-col-cyan">
                        <div class="panel-heading" role="tab" id="headingOne_1">
                            <h4 class="panel-title">
                                <a role="button" data-toggle="collapse" data-parent="#accordion_1" href="#collapseOne_1" aria-expanded="true" aria-controls="collapseOne_1">
                                    Informações Sobre Pendências<i class="material-icons">view_headline</i>
                                </a>
                            </h4>
                        </div>
                        <div id="collapseOne_1" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_1">
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <div id="dadosjus1" name="dadosjus1" class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                        <% for(Analise analise: adao.listarAnalisePendente()){
                                    ...
                                    <div id="dadosjus2" name="dadosjus2" class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <ul>
        ...
        <script src="../../js/scriptpendenciaanalise.js"></script>
