...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="lancarjustificativa">Gestao Interna - Lançar Justificativa</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Lançamento de Justificativas</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarjustificativas.jsp">Justificativa ></a></li>
                        <li><a href="javascript:void(0);">Lançar </a></li>
                        <!-- Call Search -->
...
<!--                        <div name="perfillogado" id="perfillogado" value="teste" class="email"><%=emaillog%></div>-->
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="campobdgmes" name="campobdgmes" class="number count-to" data-from="0" data-to="
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="camporealmes" name="camporealmes" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getRealmes()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="campodifmes" name="campodifmes" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getDifmes()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Orçamento Anual</div>
                            <div id="campoorcadoanual" name="campoorcadoanual" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getBdganual()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="campobdgacum" name="campobdgacum" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getBdgacum()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="camporealacum" name="camporealacum" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getRealacum()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div id="campodifacum" name="campodifacum" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getDifacum()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Saldo Anual</div>
                            <div id="camposaldoanual" name="camposaldoanual" class="number count-to" data-from="0" data-to="
                                 <% for(Contagens cont: fdao.somarValores()){%>
                                 <%=cont.getDifanual()%>
                                 <%}%>
                                 " data-speed="1000" data-fresh-interval="20" data-decimals="2"></div>
                                    ...
                                    <div id="collapseOne_2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_2">
                                        <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea id="campojustificativa" name="campojustificativa" rows="2" class="form-control no-resize auto-growth" placeholder="Inserir aqui a justificativa"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapseOne_1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_1">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bg-cyan">
                                                <h4>Informações de Justificativa</h4>
                                            </div>
                                            <div class="col-md-12">
                                                <div id="dadosjus1" name="dadosjus1" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <ul>
                                                        <li id="analiseregiao" name="analiseregiao"></li>
                                                        <li id="analisefilial" name="analisefilial"></li>
                                                        <li id="analisemagnitude" name="analisemagnitude"></li>
                                                    </ul>
                                                </div>
                                                <div id="dadosjus2" name="dadosjus2" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <ul>
                                                        <li id="analisecentro" name="analisecentro"></li>
                                                        <li id="analiseconta" name="analiseconta"></li>
                                                        <li id="analiseplataforma" name="analiseplataforma"></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div id="analise" name="analise"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_1">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                            TABELA DE ORÇAMENTO<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                <!-- Exportable Table -->
                                        ...
                                        <div id="tabela" name="tabela" class="body">
                                            <div class="table-responsive">
                                                <table id="tabelaOrcamento" name="tabelaOrcamento" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                    ...
                                                    for(Orcamento orcamento: odao.listarOrcamento()){ %>
                                                        <tr value="<%=orcamento.getId()%>">
                                                            <td id="id" data-name="<%=orcamento.getId()%>"><%=orcamento.getSegmento()%></td>
                                                            <td><%=orcamento.getRegiao()%></td>
                                                            <td><%=orcamento.getDescricaocentrodecusto()%></td>
                                                            <td><%=orcamento.getFilial()%></td>
                                                            <td><%=orcamento.getMagnitude()%></td>
                                                            <td><%=orcamento.getDescricaoconta()%></td>
                                                            <td><%=orcamento.getBdgmes()%></td>
                                                            <td><%=orcamento.getRealmes()%></td>
                                                            <td><%=orcamento.getDiferencames()%></td>
                                                            <td><%=orcamento.getBdgacum()%></td>
                                                            <td><%=orcamento.getRealacum()%></td>
                                                            <td><%=orcamento.getDiferencaacum()%></td>
                                                        </tr>
                                                        <% } %>
                                                    </tbody>
                                                </table>
