...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestao Interna - Cadastro de Condutor</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Cadastro de Condutor</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Cadastro ></a></li>
                        <li><a href="javascript:void(0);">Condutor </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_9">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                            Cadastro de Condutor<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                ...
                                                                <label class="form-label">Digitar nome</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="campomatricula" name="campomatricula" required>
                                                                <label class="form-label">Digitar matrícula do condutor</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" id="campocentro" name="campocentro" required>
                                                                <label class="form-label">Digitar centro</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="campoibutton" name="campoibutton" required>
                                                            <label class="form-label">Digitar ibutton</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="number" class="form-control" id="campocnh" name="campocnh" required>
                                                            <label class="form-label">Digitar cnh</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="campocargo" name="campocargo" required>
                                                            <label class="form-label">Digitar cargo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campocategoria" name="campocategoria" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <option>A</option>
                                                        <option>A|B</option>
                                                        <option>A|C</option>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campogsub" name="campogsub" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <% for(Unidade filial: fdao.listarIdFilial()){ %>
                                                        <option value=<%=filial.getId()%>><%=filial.getGsub()%></option>
                                                        <% } %>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campogreg" name="campogreg" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <% for(Unidade filial: fdao.listarIdFilial()){ %>
                                                        <option value=<%=filial.getId()%>><%=filial.getGrg()%></option>
                                                        <% } %>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campogdiv" name="campogdiv" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <% for(Unidade filial: fdao.listarIdFilial()){ %>
                                                        <option value=<%=filial.getId()%>><%=filial.getGdiv()%></option>
                                                        <% } %>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campounidade" name="campounidade" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <% for(Unidade filial: fdao.listarIdFilial()){ %>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campostatus" name="campostatus" class="form-control show-tick" data-live-search="true">
                                                        <option></option>
                                                        <option>Ativo</option>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control date" id="campoadminissao" name="campoadminissao" placeholder="Ex: 2017-11-10">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <b>Data de Defensiva</b>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">date_range</i>
                                                        </span>
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control date" id="campodefensiva" name="campodefensiva" placeholder="Ex: 2017-11-10">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control date" id="campovencimentocnh" name="campovencimentocnh" placeholder="Ex: 2017-11-10">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="checkbox" id="md_checkbox_70" name="md_checkbox_70" class="chk-col-green" />
                                                    <label for="md_checkbox_70">Poll</label>
                                                </div>
                                                <div class="col-md-2">
                                                    <p>
                                                        <b>Trab</b>
                                                    </p>
                                                    <input type="checkbox" id="md_checkbox_71" name="md_checkbox_71" class="chk-col-green" />
                                                    <label for="md_checkbox_71">Trab</label>
                                                </div>
                                                <div class="col-md-2">
                                                    <p>
                                                        <b>Desig</b>
                                                    </p>
                                                    <input type="checkbox" id="md_checkbox_72" name="md_checkbox_72" class="chk-col-green" />
                                                    <label for="md_checkbox_72">Desig</label>
                                                </div>
                                                <div class="col-md-2">
                                                    <p>
                                                        <b>Form 31</b>
                                                    </p>
                                                    <input type="checkbox" id="md_checkbox_73" name="md_checkbox_73" class="chk-col-green" />
                                                    <label for="md_checkbox_73">Realizado</label>
                                                </div>
                                                <div class="col-md-2">
                                                    <p>
                                                        <b>Form 32</b>
                                                    </p>
                                                    <input type="checkbox" id="md_checkbox_74" name="md_checkbox_74" class="chk-col-green" />
                                                    <label for="md_checkbox_74">Realizado</label>
                                                </div>
                                                <div class="col-md-2">
                                                    <p>
                                                        <b>Aprovado</b>
                                                    </p>
                                                    <input type="checkbox" id="md_checkbox_75" name="md_checkbox_75" class="chk-col-green" />
                                                    <label for="md_checkbox_75">Aprovado</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campoid" name="campoid" class="form-control show-tick" data-live-search="true">
                                                        ...
                                                        <% for(CondutorCad cond: fdao.listarIdCondutor()){ %>
                                                        <option value=<%=cond.getId()%>><%=cond.getId()%></option>
                                                        <% } %>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="atualizarcondutor" id="atualizarcondutor" value="atualizarcondutor" class="btn bg-cyan btn-block waves-effect" onclick="atualizarCondutor()">
                                                    <i class="material-icons">refresh</i>
                                                    <span>Atualizar</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="excluircondutor" id="excluircondutor" value="excluircondutor" class="btn bg-cyan btn-block waves-effect" onclick="excluirCondutor()">
                                                    <i class="material-icons">delete_forever</i>
                                                    <span>Excluir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="inserircondutor" id="inserircondutor" value="inserircondutor" class="btn bg-cyan btn-block waves-effect" onclick="inserirCondutor()">
                                                    <i class="material-icons">save</i>
                                                    <span>Inserir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button type="button" name="limparcondutor" id="limparcondutor" value="limparcondutor" class="btn bg-cyan btn-block waves-effect" onclick="limparCondutor()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA CONDUTORES<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                ...
                                <div class="clearfix">
                                    <div id="tabela" name="tabela" class="body">
                                        <div class="table-responsive">
                                            <table id="tabelacondutor" name="tabelacondutor" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Matricula</th>
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% for(CondutorCad cond: fdao.listarIdCondutor()){ %>
                                                    <tr value="<%=cond.getId()%>">
                                                        <td id="id" data-name="<%=cond.getId()%>"><%=cond.getId()%></td>
                                                        <td><%=cond.getMatricula()%></td>
                                                        <td><%=cond.getNome()%></td>
                                                        <td><%=cond.getCentro()%></td>
                                                        <td><%=cond.getUnidade()%></td>
                                                        <td><%=cond.getStatus()%></td>
                                                    </tr>
                                                    <% } %>
                                                </tbody>
                                            </table>
        ...
        <script src="../../js/pages/cadastro/scriptcadastrocondutor.js"></script>
