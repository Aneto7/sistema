...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="controlejustificativa">Gestão Interna - Cadastro de Tipo de Veículo</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Cadastro de Tipo de Veículo</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="../paginainicial.jsp">Início ></a></li>
                        <li><a href="dashboarcontrole.jsp">Cadastro ></a></li>
                        <li><a href="javascript:void(0);">Tipo de Veívulo </a></li>
                        <!-- Call Search -->
...
<!--                        <div class="email"><%=emaillog%></div> Buscar email no banco de dados-->
                                ...
                                <div class="panel-heading" role="tab" id="headingOne_9">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_9" href="#collapseOne_9" aria-expanded="true" aria-controls="collapseOne_9">
                                            Cadastro de Tipo de Veículo<i class="material-icons">view_headline</i>
                                        </a>
                                    </h4>
                                </div>
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="body">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="campotipoveic" name="campotipoveic" required>
                                                            <label class="form-label">Digitar Tipo do Veículo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <p class = "">
                                                        <b>Modelo de Veículo</b>
                                                    </p>
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" class="form-control" id="campomodeloveic" name="campomodeloveic" required>
                                                            <label class="form-label">Digitar Modelo do Veículo</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="campoid" name="campoid" class="form-control show-tick" data-live-search="true">
                                                        ...
                                                        <% for(ModeloVeiculo mv: fdao.listarIdModeloVeiculo()){ %>
                                                        <option value=<%=mv.getId()%>><%=mv.getId()%></option>
                                                        <% } %>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="atualizarmodelo" id="atualizarmodelo" value="atualizarmodelo" class="btn bg-cyan btn-block waves-effect" onclick="atualizarModelo()">
                                                    <i class="material-icons">refresh</i>
                                                    <span>Atualizar</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="excluirmodelo" id="excluirmodelo" value="excluirmodelo" class="btn bg-cyan btn-block waves-effect" onclick="excluirModelo()">
                                                    <i class="material-icons">delete_forever</i>
                                                    <span>Excluir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button data-type="success" type="button" name="inserirmodelo" id="inserirmodelo" value="inserirmodelo" class="btn bg-cyan btn-block waves-effect" onclick="inserirModelo()">
                                                    <i class="material-icons">save</i>
                                                    <span>Inserir</span>
                                                </button>
                                            </div>
                                            <div class="js-sweetalert col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                <button type="button" name="limparmodelo" id="limparmodelo" value="limparmodelo" class="btn bg-cyan btn-block waves-effect" onclick="limparModelo()">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne_1">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion_77" href="#collapseOne_77" aria-expanded="true" aria-controls="collapseOne_77">
                                        TABELA TIPO/MODELO DE VEÍCULOS<i class="material-icons">view_headline</i>
                                    </a>
                                </h4>
                            </div>
                            <!-- Exportable Table -->
                                        ...
                                        <div class="table-responsive">
                                            <table id="tabelaVeiculo" name="tabelaVeiculo" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                ...
                                                <tbody id="tabelaorc" name="tabelaorc">
                                                    <% for(ModeloVeiculo mv: fdao.listarIdModeloVeiculo()){ %>
                                                    <tr value="<%=mv.getId()%>">
                                                        <td id="id" data-name="<%=mv.getId()%>"><%=mv.getId()%></td>
                                                        <td><%=mv.getTipo()%></td>
                                                        <td><%=mv.getModelo()%></td>
                                                    </tr>
                                                    <% } %>
        ...
        <script src="../../js/pages/cadastro/scriptcadastromodeloveiculo.js"></script>
