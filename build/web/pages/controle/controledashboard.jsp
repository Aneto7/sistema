...
<html>
    <head>
        ...
        <title id="nometela" name="nometela" value="dashboardjustificativa">Gestao Interna - Dashboard Controle</title>
        <!-- Favicon-->
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../paginainicial.jsp"><b>LDC. - </b>Dashboard Controle</a>
                </div>
