 ...
 * @author Antonio
 */
public class ServletFiltroNumerosRevisoes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            st.executeQuery("SELECT ID, COUNT(KM) AS QUANTIDADE, MAX(KM) AS KMATUAL FROM `revisoes` WHERE "
            ...
            while (rs.next()) {
                ...
                revisao.setKm(rs.getDouble("QUANTIDADE"));
                revisao.setNumerorevisoes(rs.getInt("KMATUAL"));
        ...
        for (int i = 0; i < revisoes.size(); i++) {
            sb.append(revisoes.get(i).getId() + "%" + revisoes.get(i).getNumerorevisoes() + "%" + revisoes.get(i).getKm() + ";");
        }
