 ...
 * @author rosaan
 */
public class ServletFiltroCartao extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < cartoes.size(); i++) {
            sb.append(cartoes.get(i).getId() + "-" + cartoes.get(i).getCartao()+ ";");
        }
